...
UPDATE_PRICES_PERIOD = 6                    # hours

TRADING_SIZE = 25  #25                      # $25
TRADING_SIZE_MARGIN = 3.3  
EXPLOIT_THREAD_DELAY = 10  #15              # exploit thread period
...
PROFIT_THR_TO_OPEN_POSITIONS =  +0.0010     #+0.000300     # open position threshold (values for testing the bot)
PROFIT_THR_TO_CLOSE_POSITIONS = +0.0000     #-0.000000     # close positions threshold. Close all the positions openend by the arb thread.
NON_DIRECT_TRADE_PROFIT_THR =   +0.0030     #+0.0060     
NON_DIRECT_CLOSING_PROFIT_THR = +0.0000     #+0.0000

MAX_ITER_TO_EXIT = 300                      # 240rep / 4rep/min = 60 min   # number of empty iterations to kill the thread
