...
RATE_LIMIT_FACTOR = 1.1   #1.05             # exchange rate limit factor to stay in a "requesting rate" safe zone
...
PROFIT_THR_TO_CLOSE_POSITIONS = +0.0010     #-0.000100     # close positions threshold. Close all the positions openend by the arb thread.
NON_DIRECT_TRADE_PROFIT_THR =   +0.0060
NON_DIRECT_CLOSING_PROFIT_THR = +0.0010
